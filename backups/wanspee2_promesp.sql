...
--
-- Host: localhost:3306
-- Generation Time: Jan 17, 2024 at 01:16 PM
...
--
-- Table structure for table `contractor_details_backup`
--

CREATE TABLE `contractor_details_backup` (
  `id` int(11) NOT NULL DEFAULT 0,
  `ucode` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `concode` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ipanumber` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ipadate` date DEFAULT NULL,
  `ipafile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ircnumber` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ircfile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `cocnumber` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `cocfile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `profiledate` date DEFAULT NULL,
  `file_profile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `gps` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `create_at` datetime NOT NULL DEFAULT current_timestamp(),
  `create_by` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `update_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `update_by` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `create_org` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `update_org` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `statusnotes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `contractor_details_backup`
--

INSERT INTO `contractor_details_backup` (`id`, `ucode`, `concode`, `ipanumber`, `ipadate`, `ipafile`, `ircnumber`, `ircfile`, `cocnumber`, `cocfile`, `profiledate`, `file_profile`, `name`, `category`, `services`, `country`, `province`, `district`, `gps`, `lat`, `lon`, `create_at`, `create_by`, `update_at`, `update_by`, `create_org`, `update_org`, `status`, `statusnotes`) VALUES
...
(15, '64c9bd1b0b9031690942747', '142023-01', '2345', 'Cook Project', 'This is cook project', '', 'pip', 'PG', '14', '1402', '', '-3.573200,143.642147', '-3.573200', '143.642147', 1285.35, 11, 'Dok Man', 12, '1410001', 'Green Hills', '2023-08-02 12:19:07', 'Minad', '2023-09-11 12:41:11', 'Minad', 'active', ''),
...
(29, '64cb1a5e22f531691032158', '142023-01', '2345', 'Cooking Reels', 'pending', '2023-09-02', '', '2023-07-13', '2023-07-13', 18, '2023-08-03 13:09:18', 'Minad', '2023-09-11 18:23:08', 'Dok Man', ''),
(30, '64cb1ab2067271691032242', '142023-01', '2345', '3 Mlst', 'halted', '2023-09-02', 'This is the concern of the set documents', '0000-00-00', '0000-00-00', 18, '2023-08-03 13:10:42', 'Minad', '2023-09-06 16:12:57', 'Dok Man', '');
