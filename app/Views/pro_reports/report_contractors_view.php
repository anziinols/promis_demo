...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><b><?= $con['name'] ?></b> Dashboard</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url() ?>report_contractors_dash"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Go Back</a></li>
...
<div class="container-fluid mt-1" id="printpdf">
        ...
        <div class="col-md-12">
            <div class="card bg-dark ">
                ...
                <div class="card-header p-1">
                    <a href="<?= base_url() ?>report_contractors_dash" class=" btn btn-light text-dark"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Go Back</a>
                    <span class=" float-right btn btn-dark"><b><?= $con['concode'] ?> | <?= $con['name'] ?></b> Dashboard</span>
                </div>
            </div>
            <!-- /.card -->
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card" id="myprojects">
                ...
                <div class="card-footer">
                    <small><?= $con['concode'] ?> - <?= $con['name'] ?></small>
        ...
        <div class="col-md-12">
            <div class="card" id="mynotices">
                <div class="card-header bg-info">
                    My Notices
                    <button onclick="printCard('mynotices')" class=" btn btn-dark btn-sm float-right d-print-none"> <i class="fa fa-print" aria-hidden="true"></i> </button>
                    <button onclick="printTable('mynotices_table','My Notices')" class=" btn btn-default btn-sm float-right d-print-none"> <i class="fa fa-print" aria-hidden="true"></i> </button>
                    <button onclick="copyToImageHD('mynotices')" class=" btn btn-default btn-sm float-right d-print-none"> <i class="fa fa-copy" aria-hidden="true"></i> </button>
                </div>
                <div class="card-body table-responsive p-0">
                    <table class="table" id="mynotices_table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Notices</th>
                        ...
                        <tbody>
                            <?php $x = 1;
                            foreach ($mynotices as $mnote) : ?>
                                <tr>
                                    <td scope="row"><?= $x++ ?></td>
                                    <td scope="row"><?= $mnote['notice_title'] ?></td>
                                    <td scope="row"><?= get_notice_flags($mnote['notice_flag']) ?></td>
                                    <td><?= dateforms($mnote['notice_date']) ?></td>
                                    <td><?= datetimeforms($mnote['create_at']) ?></td>
                                    <td><?= $mnote['create_by'] ?></td>
                                    <td><?= $mnote['create_org'] ?></td>
                                    <td>
                                        <a href="<?= filecheck($mnote['file_path']) ?>"> <i class="fa fa-download" aria-hidden="true"></i> </a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card" id="othernotices">
                <div class="card-header bg-secondary">
                    <?= $tablename = "Other Notices" ?>
                    <button onclick="printCard('othernotices')" class=" btn btn-dark btn-sm float-right d-print-none"> <i class="fa fa-print" aria-hidden="true"></i> </button>
                    <button onclick="printTable('othernotices_tbl','<?= $tablename ?>')" class=" btn btn-default btn-sm float-right d-print-none"> <i class="fa fa-print" aria-hidden="true"></i> </button>
                    <button onclick="copyToImageHD('othernotices')" class=" btn btn-default btn-sm float-right d-print-none"> <i class="fa fa-copy" aria-hidden="true"></i> </button>
                </div>
                <div class="card-body table-responsive p-0">
                    <table class="table table-bordered" id="othernotices_tbl">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Notices</th>
                        ...
                        <tbody>
                            <?php $x = 1;
                            foreach ($notices as $mnote) : ?>
                                <tr>
                                    <td scope="row"><?= $x++ ?></td>
                                    <td scope="row"><?= get_notice_flags($mnote['notice_flag']) ?> <?= $mnote['notice_title'] ?></td>
                                    <td><?= dateforms($mnote['notice_date']) ?></td>
                                    <td><?= datetimeforms($mnote['create_at']) ?></td>
                                    <td><?= $mnote['create_by'] ?></td>
                                    <td><?= $mnote['create_org'] ?></td>
