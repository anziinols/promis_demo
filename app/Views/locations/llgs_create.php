        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <i class="fa fa-plus"></i> Create New LLG
                </div>
                <?= form_open('llgs_create') ?>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?= form_input('llgcode', set_value('llgcode'), ['class' => 'form-control', 'placeholder' => 'e.g., POMLG01', 'required' => 'required']) ?>
                        </div>

                        <div class="form-group col-md-6">
                            <label for="name">LLG Name <span class="text-danger">*</span></label>
                            <?= form_input('name', set_value('name'), ['class' => 'form-control', 'placeholder' => 'e.g., Moresby Northwest', 'required' => 'required']) ?>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="<?= base_url() ?>llgs" class="btn btn-secondary">CANCEL</a>
                    <button type="submit" class="btn btn-primary float-right">CREATE LLG</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
